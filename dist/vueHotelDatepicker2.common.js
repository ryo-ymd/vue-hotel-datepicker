...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_index_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("5c2a");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_index_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_9_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_9_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_9_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_9_oneOf_1_3_index_scss_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"677364ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DatePicker/index.vue?vue&type=template&id=5c4143e1&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.show)?_c('div',{ref:("DatePicker-" + _vm.hash),class:[
    'datepicker__wrapper datepicker__wrapper',
    {
      ...
      'datepicker',
      {
        ...
        ]},[(_vm.isMobile)?[(!_vm.alwaysVisible && _vm.activeMonthIndex > 0)?_c('button',{staticClass:"datepicker__button-paginate--mobile datepicker__button-paginate--mobile--top",on:{"click":_vm.renderPreviousMonth}},[_c('i',{staticClass:"arrow"})]):_vm._e()]:_vm._e(),(_vm.months.length > 0)?_vm._l((_vm.paginate),function(month,monthIndex){return _c('div',{key:(_vm.datepickerMonthKey + "-" + month),ref:"datepickerMonth",refInFor:true,staticClass:"datepicker__month",attrs:{"data-key":_vm.activeMonthIndex + month}},[(_vm.months[_vm.activeMonthIndex + month])?[_c('p',{staticClass:"datepicker__month-name"},[_vm._v(" "+_vm._s(_vm.months[_vm.activeMonthIndex + month].monthName)+" ")]),(_vm.isDesktop || _vm.alwaysVisible)?_c('DatePickerWeekRow',{class:{
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"677364ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Day.vue?vue&type=template&id=b5df88dc&
var Dayvue_type_template_id_b5df88dc_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.showTooltip && _vm.options.hoveringTooltip)?_c('div',{staticClass:"datepicker__tooltip",domProps:{"innerHTML":_vm._s(_vm.tooltipMessageDisplay)}}):_vm._e(),_c('div',{ref:"day",class:[
      'datepicker__month-day',
      _vm.dayClass,
      _vm.checkinCheckoutClass,
      _vm.bookingClass,
      { 'datepicker__month-day--today': _vm.isToday }
    ],attrs:{"data-testid":("day-" + _vm.formatDate),"tabindex":_vm.tabIndex},on:{"click":function($event){$event.preventDefault();$event.stopPropagation();return _vm.dayClicked($event, _vm.date)}}},[_c('div',{staticClass:"datepicker__month-day-wrapper"},[_c('span',[_vm._v(_vm._s(_vm.dayNumber))])])]),(_vm.currentBooking && !_vm.isDisabled)?_c('BookingBullet',{attrs:{"currentBooking":_vm.currentBooking,"duplicateBookingDates":_vm.duplicateBookingDates,"formatDate":_vm.formatDate,"previousBooking":_vm.previousBooking}}):_vm._e()],1)}
var Dayvue_type_template_id_b5df88dc_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Day.vue?vue&type=template&id=b5df88dc&
...
var timezone = __webpack_require__("1953");
...
var minMax = __webpack_require__("4650");
...
dayjs_min_default.a.extend(minMax_default.a);

var _transformDay = function transformDay(d) {
  var _window, _window$vueDatePicker;

  var getTimezone = ((_window = window) === null || _window === void 0 ? void 0 : (_window$vueDatePicker = _window.vueDatePicker) === null || _window$vueDatePicker === void 0 ? void 0 : _window$vueDatePicker.timezone) || "Europe/Paris";
  return dayjs_min_default.a.tz(d, getTimezone);
};



var helpers_addDate = function addDate(date, quantity, type) {
  var d = dayjs_min_default()(date);
  return d.add(quantity, type).toDate();
};

var helpers_subtractDate = function subtractDate(date, quantity, type) {
  var d = dayjs_min_default()(date);
  return d.subtract(quantity, type).toDate();
};

var isAfter = function isAfter(time1, time2) {
  var d1 = _transformDay(time2);

  var d2 = _transformDay(time1);

  return d1.isAfter(d2, "day");
};

var isBefore = function isBefore(time1, time2) {
  var d1 = _transformDay(time1);

  var d2 = _transformDay(time2);

  return d1.isBefore(d2, "day");
};

var isBeforeOrEqual = function isBeforeOrEqual(time1, time2) {
  var d1 = _transformDay(time2);
...
var isBetweenDate = function isBetweenDate(fromDate, toDate, givenDate) {
  var d1 = _transformDay(fromDate);

  var d2 = _transformDay(toDate);

  var d3 = _transformDay(givenDate);

  return _transformDay(d3).isBetween(d1, d2, "day", []);
};

var getDateDiff = function getDateDiff(time1, time2, type) {
  var d1 = _transformDay(time1);
...
/* harmony default export */ var helpers = ({
  transformDay: function transformDay(d) {
    return _transformDay(d);
  },
  formatTransformDay: function formatTransformDay(d) {
    return _transformDay(d).format("YYYY-MM-DD");
  },
  getNextDate: function getNextDate(datesArray, referenceDate) {
    var now = _transformDay(referenceDate);

    var closest = Infinity;
    return datesArray.find(function (d) {
      var date = _transformDay(d);
  ...
  nextDateByDayOfWeek: function nextDateByDayOfWeek(weekDay, referenceDate) {
    var newReferenceDate = _transformDay(referenceDate);

    var newWeekDay = weekDay.toLowerCase();
    var days = ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"];
    var referenceDateDay = newReferenceDate.day();
    ...
    return helpers_addDate(newReferenceDate, daysUntilNext, "day");
  },
  ...
  countDays: function countDays(start, end) {
    ...
    var d1 = _transformDay(start);

    var d2 = _transformDay(end);

    return Math.abs(d1.diff(d2, type));
  },
  substractDays: function substractDays(date, quantity) {
    return helpers_subtractDate(date, quantity, "day");
  },
  addDays: function addDays(date, quantity) {
    return helpers_addDate(date, quantity, "day");
  },
  ...
  getNextDay: function getNextDay(date, dayIndex) {
    var currentDate = date;
    currentDate.setDate(currentDate.getDate() + (dayIndex - 1 - currentDate.getDay() + 7) % 7 + 1);
    return currentDate;
  },
  getFirstDayOfMonth: function getFirstDayOfMonth(date) {
    var d = _transformDay(date);

    return d.startOf("month").toDate();
  },
  getFirstDay: function getFirstDay(date, firstDayOfWeek) {
    return _transformDay(date).startOf("month").weekday(firstDayOfWeek).format("YYYY-MM-DD");
  },
  getNextMonth: function getNextMonth(date) {
    return _transformDay(date).add(1, "month").startOf("month").toDate();
  },
  ...
  isDateIsBeforeOrEqual: function isDateIsBeforeOrEqual(fromDate, givenDate) {
  ...
  getDaysArray: function getDaysArray(start, end) {
    ...
    var lenghDifference = getDateDiff(d1.toDate(), d2.toDate(), "day");
    var arr = [];

    if (lenghDifference > 0) {
      for (var index = 0; index < lenghDifference + 1; index++) {
        var day = d1.add(index, "day").toDate();
        arr.push(day);
      }
    }
  ...
  isDateAfter: function isDateAfter(time1, time2) {
    return isAfter(time1, time2);
  },
  isDateBefore: function isDateBefore(time1, time2) {
    return isBefore(time1, time2);
  },
  isDateBeforeOrEqual: function isDateBeforeOrEqual(time1, time2) {
    return isBeforeOrEqual(time2, time1);
  },
  compareDay: function compareDay(day1, day2) {
    var date1 = _transformDay(day1).format("YYYY-MM-DD");

    var date2 = _transformDay(day2).format("YYYY-MM-DD");
  ...
  minDay: function minDay(days) {
    return dayjs_min_default.a.min(days);
  }
});
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"677364ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/BookingBullet.vue?vue&type=template&id=50e90dd0&
var BookingBulletvue_type_template_id_50e90dd0_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('i',{staticClass:"parent-bullet"},[(_vm.previousBooking && _vm.duplicateBookingDates.includes(_vm.formatDate))?_c('i',{class:[
      'bullet',
      {
...
var BookingBulletvue_type_template_id_50e90dd0_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/BookingBullet.vue?vue&type=template&id=50e90dd0&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/BookingBullet.vue?vue&type=script&lang=js&
//
//
//
//
...
var component = normalizeComponent(
  ...
  BookingBulletvue_type_template_id_50e90dd0_render,
  BookingBulletvue_type_template_id_50e90dd0_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var Dayvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    dayClass: function dayClass() {
      ...
      if (this.isHighlighted && !this.isDisabled) {
        ...
        if (Object.keys(this.checkInPeriod).length > 0 && this.checkInPeriod.periodType.includes("weekly") && this.hoveringDate && this.isDateBefore(this.date, this.hoveringDate)) {
        ...
        } else if (Object.keys(this.checkInPeriod).length > 0 && this.checkInPeriod.periodType === "nightly" && this.hoveringDate && this.hasWeeklyPeriod()) {
          return "datepicker__month-day--selected afterMinimumDurationValidDay";
        }

        if (this.hoveringPeriod.periodType === "nightly" && this.isDateBefore(this.date, this.hoveringDate)) {
          return "datepicker__month-day--selected afterMinimumDurationValidDay";
        }
      ...
      if (!this.checkOut && !this.isDisabled && this.compareDay(this.date, this.checkIn) === 1 && this.minNightCount > 0 && this.compareDay(this.date, this.addDays(this.checkIn, this.minNightCount)) === -1) {
        return "datepicker__month-day--valid datepicker__month-day--disabled datepicker__month-day--not-allowed minimumDurationUnvalidDay";
      }
    ...
    showTooltip: function showTooltip() {
      if (this.screenSize === "desktop" || this.screenSize === "tablet") {
        ...
        var showDefaultTooltip = !this.isDisabled && this.date === this.hoveringDate && this.tooltipMessageDisplay.length > 0 && this.checkIn !== null && this.checkOut === null;
  ...
  watch: {
    hoveringDate: function hoveringDate() {
      if (this.checkIn !== null && this.checkOut == null && this.isDisabled === false) {
        if (this.isDateBefore(this.checkIn, this.date) && this.isDateBefore(this.date, this.hoveringDate)) {
    ...
    activeMonthIndex: function activeMonthIndex() {
      ...
      if (this.checkIn !== null && this.checkOut !== null) {
        if (this.isDateBefore(this.checkIn, this.date) && this.isDateBefore(this.date, this.checkOut)) {
          this.isHighlighted = true;
        } else {
          this.isHighlighted = false;
        }
  ...
  methods: _objectSpread2(_objectSpread2({}, helpers), {}, {
    hasWeeklyPeriod: function hasWeeklyPeriod() {
      var hasWeeklyMonday = this.hoveringPeriod.periodType === "weekly_by_monday" && this.hoveringDate.getDay() === 1;
      var hasWeeklySunday = this.hoveringPeriod.periodType === "weekly_by_sunday" && this.hoveringDate.getDay() === 0;
      var hasWeeklySaturday = this.hoveringPeriod.periodType === "weekly_by_saturday" && this.hoveringDate.getDay() === 6;
      return this.hoveringPeriod.periodType.includes("weekly") && hasWeeklyMonday || hasWeeklySunday || hasWeeklySaturday && this.isDateBefore(this.date, this.hoveringDate);
    },
    weeklyClasses: function weeklyClasses(currentPeriod, periodType) {
      var dayIndex = null;
      ...
      if (currentPeriod.periodType === periodType && currentPeriod.startAt !== this.formatDate && currentPeriod.endAt !== this.formatDate && this.date.getDay() !== dayIndex) {
        return "datepicker__month-day--disabled datepicker__month-day--not-allowed ".concat(periodType);
    ...
    disableNextDays: function disableNextDays() {
      if (!this.isDateBefore(this.date, this.nextDisabledDate) && this.nextDisabledDate !== Infinity) {
      ...
      if (this.isDateBefore(this.checkIn, this.date) && this.options.enableCheckout) {
        this.isDisabled = false;
      }
    }
  })
...
var Day_component = normalizeComponent(
  ...
  Dayvue_type_template_id_b5df88dc_render,
  Dayvue_type_template_id_b5df88dc_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"677364ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DateInput.vue?vue&type=template&id=635611ba&
var DateInputvue_type_template_id_635611ba_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:['datepicker__input', _vm.inputClass],attrs:{"data-qa":"datepickerInput","tabindex":_vm.tabIndex}},[_vm._v(" "+_vm._s(_vm.inputDate ? _vm.inputDate : _vm.i18n[_vm.inputDateType])+" ")])}
var DateInputvue_type_template_id_635611ba_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/DateInput.vue?vue&type=template&id=635611ba&
...
var DateInput_component = normalizeComponent(
  ...
  DateInputvue_type_template_id_635611ba_render,
  DateInputvue_type_template_id_635611ba_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"677364ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DatePickerWeekRow.vue?vue&type=template&id=99bcc81e&
var DatePickerWeekRowvue_type_template_id_99bcc81e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"datepicker__week-row"},_vm._l((_vm.dayNames),function(dayName,datePickerWeekIndexMobile){return _c('div',{key:datePickerWeekIndexMobile,staticClass:"datepicker__week-name"},[_vm._v(" "+_vm._s(dayName)+" ")])}),0)}
var DatePickerWeekRowvue_type_template_id_99bcc81e_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/DatePickerWeekRow.vue?vue&type=template&id=99bcc81e&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DatePickerWeekRow.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var DatePickerWeekRowvue_type_script_lang_js_ = ({
...
// CONCATENATED MODULE: ./src/components/DatePickerWeekRow.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_DatePickerWeekRowvue_type_script_lang_js_ = (DatePickerWeekRowvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/DatePickerWeekRow.vue
...
var DatePickerWeekRow_component = normalizeComponent(
  components_DatePickerWeekRowvue_type_script_lang_js_,
  DatePickerWeekRowvue_type_template_id_99bcc81e_render,
  DatePickerWeekRowvue_type_template_id_99bcc81e_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var DatePickerWeekRow = (DatePickerWeekRow_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/DatePicker/index.vue?vue&type=script&lang=js&
...
/* harmony default export */ var DatePickervue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    paginateMobile: function paginateMobile() {
    ...
    customTooltipMessage: function customTooltipMessage() {
      var tooltip = "";
      var currentDate = this.hoveringDate;
    ...
    sortedPeriodDates: function sortedPeriodDates() {
      if (this.periodDates) {
        var periodDates = _toConsumableArray(this.periodDates);

        return periodDates.sort(function (a, b) {
          var aa = a.startAt.split("/").reverse().join();
          var bb = b.startAt.split("/").reverse().join(); // eslint-disable-next-line no-nested-ternary

          return aa < bb ? -1 : aa > bb ? 1 : 0;
        }).map(function (period) {
          var minimumDurationNights = period.periodType.includes("weekly") ? period.minimumDuration * 7 : period.minimumDuration;
          return _objectSpread2(_objectSpread2({}, period), {}, {
            minimumDurationNights: minimumDurationNights
          });
        });
      }
    ...
    isPreventedMaxMonth: function isPreventedMaxMonth() {
      ...
      return this.activeMonthIndex + this.countOfMobileMonth >= lastIndexMonthAvailable + 1;
    },
          ...
          this.$nextTick(function () {
            if (_this.checkIn && _this.checkOut) {
              ...
              if (currentSelectionIndex > 1) {
                var currentMonth = document.querySelectorAll("div[data-key=\"".concat(currentSelectionIndex, "\"]"))[0];
                if (currentMonth) swiperWrapper.scrollTop = currentMonth.offsetTop;
              }
            }
          });
        } else {
  ...
  created: function created() {
    if (this.checkIn && this.startDate && this.isDateBefore(this.dateFormater(this.checkIn), this.dateFormater(this.startDate))) {
      this.clearSelection();
    }
  ...
  methods: _objectSpread2(_objectSpread2({}, helpers), {}, {
    currentMonth: function currentMonth(month) {
      var _this$months;

      return (_this$months = this.months[this.activeMonthIndex + month]) === null || _this$months === void 0 ? void 0 : _this$months.days;
    },
    constructMonth: function constructMonth() {
      var startDate = new Date(this.startDate);
      var diffMonthBetweenStarDateAndCheckOut = this.getMonthDiff(this.startDate, this.checkOut);
      var countOfMonth = this.isDesktop ? this.countOfDesktopMonth : this.countOfMobileMonth; // Create StartDate month

      this.createMonth(startDate); // If checkIn && checkOut && difference between startDate and checkOut

      if (this.checkIn && this.checkOut && diffMonthBetweenStarDateAndCheckOut > countOfMonth) {
        // Create each month to nextMonthStartDate to checkOut date
        this.renderMultipleMonth(this.startDate, diffMonthBetweenStarDateAndCheckOut);
        var activeIndex = this.isDesktop ? 1 : this.countOfMobileMonth - 1; // Set the activeMonthIndex depend to device

        this.activeMonthIndex = Math.abs(diffMonthBetweenStarDateAndCheckOut - activeIndex);
      } else {
        // Create each month depending to countOfTotalMonthByDefault
        this.renderMultipleMonth(this.startDate, this.countOfTotalMonthByDefault - 1);
      }
    },
    numberToArr: function numberToArr(number) {
      var arr = [];
    ...
    renderMultipleMonth: function renderMultipleMonth(date, max) {
      var nextMonth = new Date(date);
      var dates = [];

      for (var countMonth = 0; countMonth < max; countMonth++) {
    ...
    getMonthName: function getMonthName(day) {
      var currentMonth = this.i18n["month-names"][lib_fecha.format(day, "M") - 1];
      var currentYear = this.showYear ? lib_fecha.format(day, " YYYY") : "";
      return "".concat(currentMonth, " ").concat(currentYear);
    },
    createMonth: function createMonth(date) {
      ...
      for (var i = 0; i < 42; i++) {
        var day = this.addDays(firstDay, i);
        month.days.push({
          date: day,
    ...
    createMultipleMonth: function createMultipleMonth(dates) {
      var _this$months2;
      ...
      for (var d = 0; d < dates.length; d++) {
        ...
        var firstDay = this.getFirstDay(currentDate, this.firstDayOfWeek);
        var month = {
          monthName: this.getMonthName(firstDayOfMonth),
          days: []
        };
      ...
      (_this$months2 = this.months).push.apply(_this$months2, months);
    },
    ...
    dayIsDisabled: function dayIsDisabled(date) {
      if (this.checkIn && !this.checkOut && !this.isDateBefore(date, this.nextDisabledDate) && this.nextDisabledDate !== Infinity) {
        return true;
      }

      if (this.checkIn && !this.checkOut && this.isDateBefore(date, this.checkIn)) {
        return true;
      }

      return false;
    },
    mouseEnterDay: function mouseEnterDay(day) {
    ...
    setCustomTooltipOnHover: function setCustomTooltipOnHover(day) {
      ...
      if (Object.keys(this.hoveringPeriod).length > 0) {
        ...
        if (this.hoveringPeriod.periodType === "weekly_by_saturday") {
          ...
          var _dayCode2 = 1;
          var _text2 = this.i18n.tooltip.mondayToMonday;
          this.showTooltipWeeklyOnHover(date, _dayCode2, _text2);
    ...
    getNextCheckInCheckOutHalfDayDate: function getNextCheckInCheckOutHalfDayDate(date) {
      if (this.halfDay && Object.keys(this.checkIncheckOutHalfDay).length > 0) {
        var _this$checkIncheckOut, _this$checkIncheckOut2;

        var checkIncheckOutHalfDayDates = Object.keys(this.checkIncheckOutHalfDay);
        var nextDateDisabled = this.getNextDate(checkIncheckOutHalfDayDates, date);
        var nextDayOfDate = this.addDays(nextDateDisabled, 1);
        var formatNextDayOfDate = this.dateFormater(nextDayOfDate);

        if ((_this$checkIncheckOut = this.checkIncheckOutHalfDay[nextDateDisabled]) !== null && _this$checkIncheckOut !== void 0 && _this$checkIncheckOut.checkIn && (_this$checkIncheckOut2 = this.checkIncheckOutHalfDay[formatNextDayOfDate]) !== null && _this$checkIncheckOut2 !== void 0 && _this$checkIncheckOut2.checkOut) {
    ...
    handleDayClick: function handleDayClick(event, date, formatDate, resetCheckin) {
      ...
      var nextDisabledDate = this.minDay([this.maxNights ? this.addDays(date, this.maxNights) : Infinity, this.getNextCheckInCheckOutHalfDayDate(date), this.getNextDate(this.sortedDisabledDates, date), this.nextDateByDayOfWeekArray(this.disabledDaysOfWeek, date), this.nextBookingDate(date), Infinity]); // let nextDisabledDate =
    ...
    nextBookingDate: function nextBookingDate(date) {
      ...
      if (this.sortBookings.length > 0) {
        ...
        var nextBooking = this.sortBookings.find(function (booking) {
          return _this6.isDateIsBeforeOrEqual(booking.checkInDate, nextDateFormated) || _this6.validateDateBetweenTwoDates(booking.checkInDate, booking.checkOutDate, nextDateFormated);
        });
    ...
    setCustomTooltipOnClick: function setCustomTooltipOnClick() {
      var _this$checkInPeriod, _this$checkInPeriod$p, _this$checkInPeriod2, _this$checkInPeriod3;

      var nextValidDate = this.addDays(this.checkIn, this.minNightCount);
      this.$set(this.checkInPeriod, "nextValidDate", nextValidDate);

      if (Object.keys(this.checkInPeriod).length > 0 && (_this$checkInPeriod = this.checkInPeriod) !== null && _this$checkInPeriod !== void 0 && (_this$checkInPeriod$p = _this$checkInPeriod.periodType) !== null && _this$checkInPeriod$p !== void 0 && _this$checkInPeriod$p.includes("weekly")) {
        this.showTooltipWeeklyOnClick();
      } else if (((_this$checkInPeriod2 = this.checkInPeriod) === null || _this$checkInPeriod2 === void 0 ? void 0 : _this$checkInPeriod2.periodType) === "nightly" && this.isDateBefore(this.checkIn, this.lastEnableDaysOfPeriod)) {
        this.showTooltipNightlyOnClick();
      } else if (((_this$checkInPeriod3 = this.checkInPeriod) === null || _this$checkInPeriod3 === void 0 ? void 0 : _this$checkInPeriod3.periodType) === "nightly" && !this.isDateBefore(this.checkIn, this.lastEnableDaysOfPeriod)) {
        this.showTooltipNightlyOnClick();
      } else {
        this.$set(this.checkInPeriod, "periodType", "nightly");
        this.$set(this.checkInPeriod, "minimumDuration", this.minNightCount);
        this.$set(this.checkInPeriod, "minimumDurationNights", this.minNightCount);
        this.showTooltipNightlyOnClick();
      }
    },
    showTooltipWeeklyOnHover: function showTooltipWeeklyOnHover(date, periodDayType, text) {
      ...
      if (isCheckInNotCheckOut) {
        ...
        if (isDateAfterMinimumDuration && notOnPeriodDayType) {
          ...
          if (this.checkInPeriod.periodType !== "nightly" && countDaysBetweenCheckInCurrentDay % 7 === 0) {
    ...
    showTooltipNightlyOnClick: function showTooltipNightlyOnClick() {
      var minNightInPeriod = this.checkInPeriod.minimumDuration;
    ...
    createHalfDayTooltip: function createHalfDayTooltip(date) {
      ...
      var nextBookableDate = null;

      if (this.checkIn) {
        nextBookableDate = this.addDays(this.checkIn, this.checkInPeriod.minimumDuration);
      }

      if (this.checkIncheckOutHalfDay[formatedHoveringDate] && !this.isDateBefore(date, nextBookableDate)) {
        this.showCustomTooltip = true;
    ...
    sortedDates: function sortedDates(dates) {
    ...
    setMinimumDuration: function setMinimumDuration(date) {
      ...
      if (this.checkIn && this.sortedPeriodDates) {
        var nextPeriodIsPriority = function nextPeriodIsPriority() {
          var _this7$nextPeriod;

          var currentPeriod = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          var minimumDurationNights = arguments.length > 1 ? arguments[1] : undefined;

          if ((_this7$nextPeriod = _this7.nextPeriod) !== null && _this7$nextPeriod !== void 0 && _this7$nextPeriod.minimumDurationNights) {
            // If NextPeriod is a weekly period
            if ((currentPeriod === null || currentPeriod === void 0 ? void 0 : currentPeriod.periodType) === "nightly" && _this7.nextPeriod.periodType.includes("weekly")) {
              return true;
            } // If NextPeriod is a nightly period


            return _this7.nextPeriod.minimumDurationNights > minimumDurationNights;
        ...
        var getEnableNextDate = function getEnableNextDate() {
          var _this7$nextPeriod2;

          var dynamicNightCounts = _this7.dynamicNightCounts === 1 ? _this7.dynamicNightCounts : _this7.dynamicNightCounts - 1;

          var enableNextDate = _this7.addDays(_this7.checkIn, dynamicNightCounts);

          if ((_this7$nextPeriod2 = _this7.nextPeriod) !== null && _this7$nextPeriod2 !== void 0 && _this7$nextPeriod2.periodType.includes("weekly") && !_this7.isDateBeforeOrEqual(_this7.checkIn, _this7.lastEnableDaysOfPeriod)) {
            // weekly by sunday
            var constraintPeriod = 0;
            if (_this7.nextPeriod.periodType === "weekly_by_saturday") constraintPeriod = 6;
            if (_this7.nextPeriod.periodType === "weekly_by_monday") constraintPeriod = 1;
            enableNextDate = _this7.substractDays(_this7.getNextDay(enableNextDate, constraintPeriod), 1);
          }

          return enableNextDate;
        };

        var setDisabledDays = function setDisabledDays() {
          var _this7$nextPeriodDisa, _this7$nextPeriod3, _this7$nextPeriodDisa2;

          var startDateCheckin = _this7.addDays(_this7.checkIn, 1);

          var enableNextDate = getEnableNextDate();
          var nextPeriodDisabledDates = [];

          var newDisablesDates = _this7.getDaysArray(startDateCheckin, enableNextDate).map(function (d) {
            return _this7.dateFormater(d);
          });

          (_this7$nextPeriodDisa = _this7.nextPeriodDisableDates).push.apply(_this7$nextPeriodDisa, _toConsumableArray(newDisablesDates)); // CheckIn + nextPeriod.minimumDuration + contrainte


          if ((_this7$nextPeriod3 = _this7.nextPeriod) !== null && _this7$nextPeriod3 !== void 0 && _this7$nextPeriod3.periodType.includes("weekly")) {
            var nextPeriodEnableDay = _this7.addDays(_this7.checkIn, _this7.nextPeriod.minimumDurationNights); // weekly by sunday
            ...
            if (nextPeriodEnableDay.getDay() !== constraintPeriod) {
              nextPeriodEnableDay = _this7.getNextDay(nextPeriodEnableDay, constraintPeriod);
              nextPeriodDisabledDates = _this7.getDaysArray(_this7.addDays(_this7.nextPeriod.startAt, 1), _this7.substractDays(nextPeriodEnableDay, 1)).map(function (d) {
                return _this7.dateFormater(d);
              });
            }
          ...
          (_this7$nextPeriodDisa2 = _this7.nextPeriodDisableDates).push.apply(_this7$nextPeriodDisa2, _toConsumableArray(newDisablesDates).concat(_toConsumableArray(nextPeriodDisabledDates)));

          _this7.nextPeriodDisableDates = _toConsumableArray(new Set(_this7.nextPeriodDisableDates));
          _this7.nextPeriodDisableDates = _this7.sortedDates(_this7.nextPeriodDisableDates);
        };

        var getPeriod = function getPeriod(currentDate) {
          var compareDate = _this7.dateFormater(currentDate);

          var day = null;

          _this7.sortedPeriodDates.forEach(function (d) {
            if (d.endAt !== compareDate && (d.startAt === compareDate || _this7.validateDateBetweenTwoDates(d.startAt, d.endAt, currentDate))) {
              day = d;
            }
          });
        ...
        var currentPeriod = getPeriod(date); // If currentPeriod

        if (currentPeriod) {
          var currentPeriodIndex = this.sortedPeriodDates.findIndex(function (p) {
            return p.startAt === currentPeriod.startAt;
          });
          ...
          var setLastEnableDaysOfPeriod = function setLastEnableDaysOfPeriod() {
            if (!_this7.nextPeriod || _this7.nextPeriod.startAt === currentPeriod.endAt) {
              return _this7.substractDays(currentPeriod.endAt, currentPeriod.minimumDurationNights);
            }

            return _this7.substractDays(_this7.nextPeriod.startAt, currentPeriod.minimumDurationNights);
          };

          this.lastEnableDaysOfPeriod = setLastEnableDaysOfPeriod(); // Calculate dynamic minimum nights with nextPeriod

          var nextDisableDates = this.getDisableDaysOfTheNextedPeriod(currentPeriod);

          if (!this.isDateBeforeOrEqual(this.checkIn, this.lastEnableDaysOfPeriod) && nextPeriodIsPriority(currentPeriod, currentPeriod.minimumDurationNights)) {
            this.dynamicNightCounts = this.nextPeriod.minimumDurationNights;
            this.checkInPeriod = _objectSpread2({}, this.nextPeriod);
            setDisabledDays();
          } else {
            this.checkInPeriod = _objectSpread2({}, currentPeriod);
            this.dynamicNightCounts = currentPeriod.minimumDurationNights;

            if (nextDisableDates && nextPeriodIsPriority(currentPeriod, currentPeriod.minimumDurationNights)) {
              var copyNextPeriodDisableDates = this.nextPeriodDisableDates;
              var nextDisableDatesFormat = nextDisableDates.map(function (d) {
                return _this7.dateFormater(d, "YYYY-MM-DD");
              });
              nextDisableDatesFormat = nextDisableDatesFormat.filter(function (d) {
                return !copyNextPeriodDisableDates.includes(d);
              });
              ...
              if (nextDisableDatesFormat.length > 0) {
                ...
                this.nextPeriodDisableDates = this.sortedDates(copyNextPeriodDisableDates);
              }
            }
          ...
          var checkInWithMinimumDuration = this.addDays(this.checkIn, this.minNightCount > 1 ? this.minNightCount - 1 : this.minNightCount);
    ...
    getDisableDaysOfTheNextedPeriod: function getDisableDaysOfTheNextedPeriod(currentPeriod) {
      var nextPeriodIndex;
      this.sortedPeriodDates.forEach(function (x, i) {
        if (currentPeriod.startAt === x.startAt) nextPeriodIndex = i + 1;
      });

      if (this.sortedPeriodDates[nextPeriodIndex]) {
        var nextPeriod = _objectSpread2({}, this.sortedPeriodDates[nextPeriodIndex]);

        var isNightlyNextPeriod = nextPeriod.periodType === "nightly";

        if (currentPeriod.periodType.includes("weekly") && isNightlyNextPeriod) {
          return null;
        }

        var nextDate = this.addDays(this.checkIn, nextPeriod.minimumDurationNights);
        var nextStartNextPeriod = this.addDays(nextPeriod.startAt, 1);
    ...
    checkNextPeriod: function checkNextPeriod() {
      var _this8 = this;

      var nextPeriodIndex;
      this.sortedPeriodDates.forEach(function (x, i) {
        var nextPeriod = _this8.isDateAfter(x.startAt, _this8.checkIn);
      ...
      if (this.sortedPeriodDates[nextPeriodIndex]) {
        ...
        var nextDate = this.addDays(this.checkIn, nextPeriod.minimumDurationNights);
        var nextStartNextPeriod = this.addDays(nextPeriod.startAt, 1);
        this.nextPeriodDisableDates = this.getDaysArray(nextStartNextPeriod, nextDate).map(function (d) {
          return _this8.dateFormater(d, "YYYY-MM-DD");
        });
        this.nextPeriodDisableDates = this.sortedDates(this.nextPeriodDisableDates);
      }
    },
    ...
    renderNextMonth: function renderNextMonth() {
      ...
      var countOfDesktopMonth = this.isDesktop ? this.countOfDesktopMonth : this.countOfMobileMonth;
      ...
      if (this.isMobile) {
        firstDayOfLastMonth = this.months[this.months.length - 1].days.find(function (day) {
          return day.belongsToThisMonth === true;
        });
      } else {
        firstDayOfLastMonth = this.months[this.activeMonthIndex + 1].days.find(function (day) {
          return day.belongsToThisMonth === true;
        });
      }
...
/******/ });
//# sourceMappingURL=vueHotelDatepicker2.common.js.map